...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl = new FlxSprite(1760, -391);
		logoBl.frames = Paths.getSparrowAtlas('fallmen/Title/logoBumpin');
		logoBl.scale.set(0.805633803, 0.805633803);
		...
		titleGuy.animation.addByPrefix('bounce', 'fgIdle', 24);
		titleGuy.animation.play('bounce');
		titleGuy.updateHitbox();

		swagShader = new ColorSwap();
		gfDance = new FlxSprite(titleJSON.gfx, titleJSON.gfy);
		gfDance.frames = Paths.getSparrowAtlas('fallmen/Title/gfDanceTitle');
	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro && youcanpress == true)
		{
			if(pressedEnter)
			{
				...
				FlxG.save.data.DEMOiucwneyiocmqxoimwquixwmpqxwmohxuuiqpoxuhmxrtyretyriyuhjgbnvsdfwpqo = true;
