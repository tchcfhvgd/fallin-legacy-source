...
typedef WeekFile =
{
	...
	var lolthismessesupfreeplay:Bool;
...
class WeekData {
	...
	public var lolthismessesupfreeplay:Bool;
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		lolthismessesupfreeplay = weekFile.lolthismessesupfreeplay;
			...
			for (j in 0...directories.length) {
				...
				if(!weeksLoaded.exists(sexList[i])) {
					...
					if(week != null) {
						...
						if(weekFile != null && (isStoryMode == null || (isStoryMode && !weekFile.hideStoryMode) || (!isStoryMode && !weekFile.lolthismessesupfreeplay))) {
	...
	private static function addWeek(weekToCheck:String, path:String, directory:String, i:Int, originalLength:Int)
	{
		if(!weeksLoaded.exists(weekToCheck))
		{
			...
			if(week != null)
			{
				...
				if((PlayState.isStoryMode && !weekFile.hideStoryMode) || (!PlayState.isStoryMode && !weekFile.lolthismessesupfreeplay))
				{
